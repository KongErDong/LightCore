...
namespace LightCore
{
    ...
    public class ScrollView : ScrollRect
    {
        ...
        // callbacks for items
        public Func<int, Vector2> ItemSzie;
        public Func<int, RectTransform> itemGetFunc;
        public Action<RectTransform> itemRecycleFunc;

        public IList BindingData { set; get; }
        public Action<int, object, RectTransform> UpdateItem;
        ...
        private void InternalUpdateData()
        {
            ...
            int newDataCount = 0;
            newDataCount = BindingData.Count;
        ...
        void SetDataForItemAtIndex(RectTransform item, int index)
        {
            if (UpdateItem != null)
            {
                UpdateItem(index, BindingData[index], item);
            }
